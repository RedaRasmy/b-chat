...
import { UpdateProfileSchema, type UpdateProfileData } from "@bchat/shared/validation"
...
export default function Settings() {
    ...
    return (
        <div className={"grid md:grid-cols-2 gap-2 p-1"}>
            <Card className="">
                                ...
                                render={({ field, fieldState }) => (
                                    <Field data-invalid={fieldState.invalid}>
                                        <FieldLabel htmlFor="name">
                                            {t("profile:profileUpdating.name.label")}
                                        </FieldLabel>
                                        <Input
                                            {...field}
                                            id="name"
                ...
                <CardFooter>
                    <Field orientation="horizontal" className="gap-1">
                        <Button variant={"outline"} disabled={nameUnchanged} onClick={reset}>
            ...
            <Card className="flex">
                <CardHeader>
                    <CardTitle className="">{t("profile:preferences.title")}</CardTitle>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex flex-col gap-2">
                        <Label htmlFor="select-theme">{t("profile:preferences.theme.label")}</Label>
                        <ThemeSelector />
                    </div>
                </CardContent>
                <CardFooter>
            ...
            <Card className="">
                <CardHeader>
                    <CardTitle className="text-de">{t("profile:accountDeletion.title")}</CardTitle>
                    <CardDescription>{t("profile:accountDeletion.description")}</CardDescription>
                </CardHeader>
                <CardContent>
                    <ActionButton
